...
\begin{center}
    \begin{tabularx}{\textwidth}{Xcl}
      ...
      Schritt 1:\\
      $\cdot$ wähle Primzahl: $p = 17$\\
      $\cdot$ finde Erzeuger: $g = 5$\\
      $\cdot$ wähle geheimen Schlüssel: $a = 10$\\
      $\cdot$ berechne öffentlichen Schlüssel:\\
      $A \equiv g^a \mod p$\\
      $A = 5^{10} \mod 17$\\
      $A = 9$\\
      $\cdot$ sende: $(g = 5, p = 17, A = 9)$ an Bob & $\to$\text{                                        }
    \end{tabularx}
  \end{center}
  ...
  \begin{center}
    \begin{tabularx}{\textwidth}{lcX}
     ...
     \text{       }& \text{       } & $\cdot$ wähle: geheimen Schlüssel: $b\in \{ 1 ,\ldots , p - 1 \}$\\
