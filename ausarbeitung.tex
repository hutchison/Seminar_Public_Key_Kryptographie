...
\begin{beispiel}
  ...
  Lösung $b$ lediglich um den 10-Milliardstel Teil ($= 1/10^{10}$) der gesamten Anzahl der 
  möglichen Lösungen $d = (p-2)/10^{10} \approx p/{10^{10}}$ abweicht, um dann (zufällig) weiter in 
  ...
  bestimmen. Man wüsste also auch erst nach 14 Jahren, dass man ''sehr gut'' geraten hat.
