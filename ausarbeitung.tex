...
\begin{beispiel}
  ...
  Lösung $b$ lediglich um $d$, den 10-Milliardstel Teil ($= 1/10^{10}$) von der gesamten Anzahl der 
  möglichen Lösungen $\left| \Z_p^* \right| = (p-2)$, abweicht, um dann (zufällig) weiter in 
